# Getting help with `FileSetExperiment`

Thank you for using `FileSetExperiment`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/FileSetExperiment`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/FileSetExperiment),
...
[search issues and pull requests](https://github.com/trichelab/FileSetExperiment/issues)
